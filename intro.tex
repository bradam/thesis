...
\linespread{1.3}
\usepackage[margin=0.9in, left=1.38in]{geometry}
\usepackage{listings}
\usepackage{xcolor}		
...
A klasszikus megfogalmazás szerint~\parencite{chandy} egy elosztott rendszer véges számú folyamatot és csatornát tartalmaz, amik valamilyen módon kapcsolatban vannak egymással. A csatornáktól elvárjuk, hogy végtelen bufferként szolgáljanak, hiba mentesek legyenek a rajtuk átküldött üzenetek és sorrendben továbbítsák az adatot. Egy csatorna állapotán az átküldött üzenetek csoportját értjük, a folyamatokra pedig jellemző az állapotok sorozata a kezdeti állapot és események sorozata.

\begin{figure}[H]
\centering
\includegraphics[width=100mm]{img/distSys.png}
\caption{Elosztott rendszer felépítése $p, q, r$ folyamatoknál és $c1, c2, c3, c4$ csatornák esetében~\parencite{chandy} alapján.
\label{distSys}}
\end{figure}
